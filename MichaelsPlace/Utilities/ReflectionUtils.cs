 ...
 static class ReflectionUtils
    {
        ...
        {
            return GetAttribute(objectType, typeof(TAttribute)) as TAttribute;
        }
        ...
        public static bool HasAttribute<TAttribute>(this Type objectType) where TAttribute : Attribute
        {
            return HasAttribute(objectType, typeof(TAttribute));
        }
